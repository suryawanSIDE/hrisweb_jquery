                    ...
                    if (getObj.reqAction === 'view') {
                        ...
                        set_Right_Panel_Bottom({
                            ...
                            'btnDetail': permission.btn_read, 
                                'eventDetail': 'onclick="Parameter_Major_Subject_Event(`Form`, `'+ tagId +'`, `detail`)"',
                            'btnAdd': permission.btn_create, 
                                'eventAdd': 'onclick="Parameter_Major_Subject_Event(`'+ formType +'`, `'+ tagId +'`, `add`)" ondblclick="Parameter_Major_Subject_Event(`'+ formType +'`, `'+ tagId +'`, `add`)"',
                            'btnEdit': permission.btn_update,
                                'eventEdit': 'onclick="Parameter_Major_Subject_Event(`'+ formType +'`, `'+ tagId +'`, `edit`)" ondblclick="Parameter_Major_Subject_Event(`'+ formType +'`, `'+ tagId +'`, `edit`)"',
                            'btnExport': permission.btn_export,
                                'eventExport': 'onclick="Confirm_Form(`'+ tagId +'`, `export`, `Parameter_Major_Subject_Event`)" ondblclick="Confirm_Form(`'+ tagId +'`, `export`, `Parameter_Major_Subject_Event`)"',
                            'btnImport': permission.btn_import,
                                'eventImport': '',
                            'btnImport_Format': permission.format_import,
                                'eventImport_Format': '',
                            'btnDelete': permission.btn_delete,
                                'eventDelete': 'onclick="Confirm_Form(`'+ tagId +'`, `delete`, `Parameter_Major_Subject_Event`)" ondblclick="Confirm_Form(`'+ tagId +'`, `delete`, `Parameter_Major_Subject_Event`)"',
                        });
                    } // reqAction view
    ...
    function _Form(getObj) {
        ...
        */
        ...
        set_Form_Button({
            'tagId': tagId,
            'action': action,
            'eventSave_All': 'onclick="Parameter_Major_Subject_Event(`Save_Data`, `'+ tagId +'`, `'+ action +'`)"',
            'eventNewForm': 'onclick="Parameter_Major_Subject_Event(`Form`, `'+ tagId +'`, `add`)"',
			'eventReload_All': 'onclick="Parameter_Major_Subject_Event(`Form`, `'+ tagId +'`, `reload`)"'
        });
