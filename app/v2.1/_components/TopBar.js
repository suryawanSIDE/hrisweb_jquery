	...
	if (deviceType === 'dekstop') {
		freezeButton = '<div class="btn-group">'+
							'<button onclick="set_Panel_FreezeCol(`'+ tagId +'`)" class="btn btn-default btn-sm">'+
								'<span class="glyphicon glyphicon-indent-left"></span>&nbsp;<span class="dekstop-label">Freeze: </span><span class="my-value-freezecol">'+ globalData[tagId]['tableProperty']['tableFreeze'] +'</span>'+
							'</button>'+
					...
					'<span class="btn-group">'+
						...
						'<div class="btn-group">'+
							'<button onclick="set_Panel_ShowRow(`'+ tagId +'`)" class="btn btn-default btn-sm">'+
								'<span class="glyphicon glyphicon-resize-vertical"></span>&nbsp;<span class="dekstop-label">Show: </span><span class="my-value-showrow">'+ displayRow +'</span>'+
							'</button>'+
							'<div class="my-container-showrow my-hide"></div>'+
						'</div>'+
						'<div class="btn-group">'+
							'<button class="btn btn-default btn-sm">'+
								'<span class="dekstop-label">All: </span><span class="my-value-numrow">0</span>&nbsp;|&nbsp;'+
								'<span class="dekstop-label">/Pg: </span><span class="my-value-numrowpage">0</span>&nbsp;|&nbsp;'+
								'<span class="dekstop-label">Selected: </span><span class="my-value-numselected">0</span>'+
							'</button>'+
						'</div>'+
