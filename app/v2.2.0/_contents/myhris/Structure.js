...
// ======== MAIN
    ...
    function __Global_Data_This(tagId) {
        ...
        */
        ...
        globalData[tagId]['urlController'] = 'myhris/Structure/'; //> modify module
            ...
            success: (response) => {    
                ...
                if (myObj.status === 'success') {
                    if (getObj.reqAction === 'view') {
                        ...
                        if (dataDb.length > 0) {
                            ...
                            $.map(dataDb, ( rowData, x ) => {
                                ...
                                // for global variable
                                    ...
                                    dataTable_Col['col_text_alert'] = rowData.col_structure_display +' '+ rowData.col_department;
									...
									dataTable_Col['col_structure']		  = rowData.col_structure;
									dataTable_Col['col_structure_level']  = rowData.col_structure_level;
									dataTable_Col['col_parent_structure'] = rowData.col_parent_structure;
									dataTable_Col['col_parent_level']	  = rowData.col_parent_level;
									dataTable_Col['col_department_code']  = rowData.col_department_code;
                        ...
                        // > modify
						const eventDetail 		= 'Structure_Event(`'+ tagId +'`, `detail_Key`)';
						const eventAdd 			= 'Structure_Event(`'+ tagId +'`, `add_Key`)';
						const eventEdit			= 'Structure_Event(`'+ tagId +'`, `edit_Key`)';
						...
						$.map(dataDb, ( rowData, x ) => {
							...
							// for global variable
								...
								currentData[selectedCb_Index]['col_text_alert'] = rowData.col_structure_display +' '+ rowData.col_department;
								...
								currentData[selectedCb_Index]['col_structure']		 = rowData.col_structure;
								currentData[selectedCb_Index]['col_structure_level'] = rowData.col_structure_level;
								currentData[selectedCb_Index]['col_parent_structure']= rowData.col_parent_structure;
								currentData[selectedCb_Index]['col_parent_level']	 = rowData.col_parent_level;
								currentData[selectedCb_Index]['col_department_code'] = rowData.col_department_code;
...
// ======== FORM
        ...
        //> modify module
			...
			fieldForm.push({ // 5
					...
					if (paramLength === 0) {
						globalData[tagId]['dataAutofill_Param'].push({
						'col': col,
						'listRequest': 'structure',
						'listFormat': 'list', // list/table
						'selectedFunction': 'Structure_Event',
						'eventParam': '_select_Structure'
						});	
					}
			...
			fieldForm.push({ // 6
					...
					if (paramLength === 0) {
						globalData[tagId]['dataAutofill_Param'].push({
						'col': col,
						'listRequest': 'department',
						'listFormat': 'list', // list/table
						'selectedFunction': 'Structure_Event',
						'eventParam': '_select_Department'
						});	
					}
    ...
    function _Form(getObj) {
        ...
        */
        ...
        const eventSave_All 	= 'Structure_Event(`'+ tagId +'`, `save_Key`)';
        const eventNewForm  	= 'Structure_Event(`'+ tagId +'`, `add_Key`)';
		const eventReload_All	= 'Structure_Event(`'+ tagId +'`, `reload_Key`)';
		set_Form_Button({
            'tagId': tagId,
            'action': action,
        ...
        function __process_Form() {
            ...
            switch(action) {
                case 'add':
                    ...
                    dataTable['col_structure']		  = '';
					dataTable['col_structure_level']  = '';
					dataTable['col_parent_structure'] = '';
					dataTable['col_parent_level']	  = '';
					dataTable['col_department_code']  = '';
				...
				case 'reload':
					...
					const mytimer = setTimeout(() => {						
						...
						Structure_Event(tagId, 'edit_Key')
					}, 5); // 5 ms
       ...
       let formChild	 = {};
		...
		globalData[tagId]['dataForm'].push({
			...
			'col_data_key': data['col_data_key'],
				...
				'col_structure': data['col_structure'],
				'col_structure_level': data['col_structure_level'],
				'col_parent_structure': data['col_parent_structure'],
				'col_parent_level': data['col_parent_level'],
				'col_department_code': data['col_department_code'],
			'arrChild': []
			});
        ...
        function __process_Save() {
            ...
            for (let x=0; x<formLength; x++) {
                ...
                for (let y=0; y<inputLength; y++) {
					...
					dataFormCol['col_parent_level']	 	= globalData[tagId]['dataForm'][x].col_parent_level;
					dataFormCol['col_department_code']	= globalData[tagId]['dataForm'][x].col_department_code;
                            ...
                            if (reqAction === 'add') {
                                ...
                                $.map(dataDb, ( rowData, x ) => {
                                    ...
                                    // for global variable
                                        ...
                                        currentData[x]['col_text_alert'] = rowData.col_structure_display +' '+ rowData.col_department;
                                        ...
                                        currentData[x]['col_structure']		  = rowData.col_structure;
										currentData[x]['col_structure_level'] = rowData.col_structure_level;
										currentData[x]['col_parent_structure']= rowData.col_parent_structure;
										currentData[x]['col_parent_level']	  = rowData.col_parent_level;
										currentData[x]['col_department_code'] = rowData.col_department_code;
	...
	function __select_Structure(getObj) {
		...
		baseEl_Item.find(".item-data-col .col-data").eq(1)
			.val(dataTable[listIndex].col_structure);
		
		// department
		baseEl_Item.find(".item-data-col .col-data").eq(2)
			.val(dataTable[listIndex].col_department);
			
		// update globalData dataForm
		globalData[tagId]['dataForm'][form_Index]['col_parent_code']  	= dataTable[listIndex].col_code_structure;
		globalData[tagId]['dataForm'][form_Index]['col_parent_level'] 	= dataTable[listIndex].col_level; // parent level
		globalData[tagId]['dataForm'][form_Index]['col_department_code']= dataTable[listIndex].col_code_department; 
	...
	function __select_Department(getObj) {
...
// ======== FORM
    ...
    switch (getObj.setFunction) {
        ...
        break;
        case '_select_Structure': 
			functionResult = __select_Structure(getObj);
		break;
		case '_select_Department': 
			functionResult = __select_Department(getObj);
		break;
		default:
...
//> modify module
function Structure_Event(tagId, eventId, targetThis) {
