            ...
            success: (response) => {    
                ...
                if (myObj.status === 'success') {
                    if (getObj.reqAction === 'view') {
                        ...
                        const eventDetail 		= 'Area_Province_Event(`Form`, `'+ tagId +'`, `detail`)';
						const eventAdd 			= 'Area_Province_Event(`'+ formType +'`, `'+ tagId +'`, `add`)';
						const eventEdit			= 'Area_Province_Event(`'+ formType +'`, `'+ tagId +'`, `edit`)';
						const eventExport		= 'Confirm_Form(`'+ tagId +'`, `export`, `Area_Province_Event`)';
						//const eventImport		= '';
						//const eventImport_Format= '';
						const eventDelete		= 'Confirm_Form(`'+ tagId +'`, `delete`, `Area_Province_Event`)';
...
// ======== FORM
    ...
    function _Form(getObj) {
        ...
        */
		...
		//> modify module
        const eventSave_All 	= 'Area_Province_Event(`Save_Data`, `'+ tagId +'`, `'+ action +'`)';
        const eventNewForm  	= 'Area_Province_Event(`Form`, `'+ tagId +'`, `add`)';
		const eventReload_All	= 'Area_Province_Event(`Form`, `'+ tagId +'`, `reload`)';
		set_Form_Button({
            'tagId': tagId,
            'action': action,
