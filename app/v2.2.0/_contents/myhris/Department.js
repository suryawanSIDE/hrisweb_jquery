...
// ======== MAIN
    ...
    function __Global_Data_This(tagId) {
        ...
        */
        ...
        globalData[tagId]['urlController'] = 'myhris/Department/'; //> modify module
            ...
            success: (response) => {    
                ...
                if (myObj.status === 'success') {
                    if (getObj.reqAction === 'view') {
                        ...
                        if (dataDb.length > 0) {
                            ...
                            $.map(dataDb, ( rowData, x ) => {
                                ...
                                // for global variable
                                    ...
                                    dataTable_Col['col_text_alert'] = rowData.col_department_display;
									...
									dataTable_Col['col_department']		  = rowData.col_department;
									dataTable_Col['col_department_level']  = rowData.col_department_level;
									dataTable_Col['col_parent_department'] = rowData.col_parent_department;
                        ...
                        // > modify
						const eventDetail 		= 'Department_Event(`'+ tagId +'`, `detail_Key`)';
						const eventAdd 			= 'Department_Event(`'+ tagId +'`, `add_Key`)';
						const eventEdit			= 'Department_Event(`'+ tagId +'`, `edit_Key`)';
						...
						$.map(dataDb, ( rowData, x ) => {
							...
							// for global variable
								...
								currentData[selectedCb_Index]['col_text_alert'] = rowData.col_department_display;
								...
								currentData[selectedCb_Index]['col_department']		 = rowData.col_department;
								currentData[selectedCb_Index]['col_department_level'] = rowData.col_department_level;
								currentData[selectedCb_Index]['col_parent_department']= rowData.col_parent_department;
...
// ======== FORM
        ...
        //> modify module
			...
			fieldForm.push({ // 5
					...
					if (paramLength === 0) {
						...
						'selectedFunction': 'Department_Event',
    ...
    function _Form(getObj) {
        ...
        */
        ...
        const eventSave_All 	= 'Department_Event(`'+ tagId +'`, `save_Key`)';
        const eventNewForm  	= 'Department_Event(`'+ tagId +'`, `add_Key`)';
		const eventReload_All	= 'Department_Event(`'+ tagId +'`, `reload_Key`)';
		set_Form_Button({
            'tagId': tagId,
            'action': action,
        ...
        function __process_Form() {
            ...
            switch(action) {
                case 'add':
                    ...
                    dataTable['col_department']		  = '';
					dataTable['col_department_level']  = '';
					dataTable['col_parent_department'] = '';
				...
				case 'reload':
					...
					const mytimer = setTimeout(() => {						
						...
						Department_Event(tagId, 'edit_Key')
					}, 5); // 5 ms
       ...
       let formChild	 = {};
		...
		globalData[tagId]['dataForm'].push({
			...
			'col_data_key': data['col_data_key'],
				...
				'col_department': data['col_department'],
				'col_department_level': data['col_department_level'],
				'col_parent_department': data['col_parent_department'],
                            ...
                            if (reqAction === 'add') {
                                ...
                                $.map(dataDb, ( rowData, x ) => {
                                    ...
                                    // for global variable
                                        ...
                                        currentData[x]['col_text_alert'] = rowData.col_department_display;
                                        ...
                                        currentData[x]['col_department']		  = rowData.col_department;
										currentData[x]['col_department_level'] = rowData.col_department_level;
										currentData[x]['col_parent_department']= rowData.col_parent_department;
	...
	function __select_Department(getObj) {
		...
		// update globalData dataForm
		globalData[tagId]['dataForm'][form_Index]['col_parent_code']  = dataTable[listIndex].col_code_department;
...
//> modify module
function Department_Event(tagId, eventId, targetThis) {
