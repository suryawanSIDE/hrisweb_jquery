    ...
    function __Global_Data_This(tagId) {
        ...
        */
		...
		globalData[tagId]['dataEvent']['confirm_delete_Key'] = {
											'nextFunction': 'Area_Country_Event',
											'action': 'delete'
											}
...
// ======== FORM
    ...
    function _Form(getObj) {
        ...
        */
        ...
        const eventSave_All 	= 'Area_Country_Event(`'+ tagId +'`, `save_Key`)';
        const eventNewForm  	= 'Area_Country_Event(`'+ tagId +'`, `add_Key`)';
		const eventReload_All	= 'Area_Country_Event(`'+ tagId +'`, `reload_Key`)';
		set_Form_Button({
            'tagId': tagId,
            'action': action,
            ...
            switch(action) {
				...
				case 'reload':
					...
					const mytimer = setTimeout(() => {						
						...
						Area_Country_Event(tagId, 'edit_Key')
					}, 5); // 5 ms
...
//> modify module
function Area_Country_Event(tagId, eventId, targetThis) {
