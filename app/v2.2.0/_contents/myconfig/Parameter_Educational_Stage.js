    ...
    function __Global_Data_This(tagId) {
        ...
        */
		...
		globalData[tagId]['dataEvent']['confirm_delete_Key'] = {
											'nextFunction': 'Parameter_Educational_Stage_Event',
											'action': 'delete'
											}
...
// ======== FORM
    ...
    function _Form(getObj) {
        ...
        */
        ...
        const eventSave_All 	= 'Parameter_Educational_Stage_Event(`'+ tagId +'`, `save_Key`)';
        const eventNewForm  	= 'Parameter_Educational_Stage_Event(`'+ tagId +'`, `add_Key`)';
		const eventReload_All	= 'Parameter_Educational_Stage_Event(`'+ tagId +'`, `reload_Key`)';
		set_Form_Button({
            'tagId': tagId,
            'action': action,
            ...
            switch(action) {
				...
				case 'reload':
					...
					const mytimer = setTimeout(() => {						
						...
						Parameter_Educational_Stage_Event(tagId, 'edit_Key')
					}, 5); // 5 ms
...
//> modify module
function Parameter_Educational_Stage_Event(tagId, eventId, targetThis) {
